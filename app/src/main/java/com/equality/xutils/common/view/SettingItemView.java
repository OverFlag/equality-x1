...
import com.equality.xutils.utils.DisplayUtils;
...
public class SettingItemView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        LayoutInflater.from(context).inflate(R.layout.tx_item_setting_view, this);
        initView();
    ...
    private void obtainAttrs(Context context, AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(mLeftIconWidth, mLeftIconHeight);
        params.addRule(RelativeLayout.CENTER_VERTICAL);
        params.setMargins(0, 0, DisplayUtils.dip2px(context, 10), 0);
        ivLeftIcon.setLayoutParams(params);
        ivRightIcon.setLayoutParams(new LayoutParams(mRightIconWidth, mRightIconHeight));
